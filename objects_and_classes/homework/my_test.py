...
car1 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
car2 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
car3 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
car4 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
car5 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
car6 = Car(price=random.randint(5000, 50000), car_type=random.choice(CARS_TYPES),
           producer=random.choice(CARS_PRODUCER), mileage=random.randint(1000, 5000))
...
print(garage2 == garage2)
print(garage2.__hash__())
garage2.add(car5)
print(garage2.__hash__())
...
for key in c4.garages.keys():
    print(key.__hash__())
# print(c4.garages.keys())
